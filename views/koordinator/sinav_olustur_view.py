...
class SinavOlusturView(QWidget):
    ...
    def setup_programs_tab(self):
        ...
        self.programs_table.verticalHeader().setDefaultSectionSize(65)
    ...
    def setup_create_tab(self):
        ...
        self.sinav_suresi.setMinimumWidth(120)
        ...
        self.ara_suresi.setMinimumWidth(120)
        ...
        gunluk_limit_layout.setSpacing(10)
        ...
        self.gunluk_sinav_limiti.setFixedWidth(70)
        ...
        self.ilk_sinav_saat.setFixedWidth(65)
        ...
        self.ilk_sinav_dakika.setFixedWidth(65)
        first_layout.addWidget(self.ilk_sinav_saat)
        sep1 = QLabel(":")
        sep1.setStyleSheet("font-size: 16px; font-weight: bold; padding: 0 4px;")
        ...
        self.son_sinav_saat.setFixedWidth(65)
        ...
        self.son_sinav_dakika.setFixedWidth(65)
        last_layout.addWidget(self.son_sinav_saat)
        sep2 = QLabel(":")
        sep2.setStyleSheet("font-size: 16px; font-weight: bold; padding: 0 4px;")
        ...
        lunch_start_layout.setSpacing(8)
        ...
        self.ogle_baslangic_saat.setFixedWidth(65)
        ...
        self.ogle_baslangic_dakika.setFixedWidth(65)
        lunch_start_layout.addWidget(self.ogle_baslangic_saat)
        sep3 = QLabel(":")
        sep3.setStyleSheet("font-size: 16px; font-weight: bold; padding: 0 4px;")
        ...
        self.ogle_bitis_saat.setFixedWidth(65)
        ...
        self.ogle_bitis_dakika.setFixedWidth(65)
        lunch_end_layout.addWidget(self.ogle_bitis_saat)
        sep4 = QLabel(":")
        sep4.setStyleSheet("font-size: 16px; font-weight: bold; padding: 0 4px;")
